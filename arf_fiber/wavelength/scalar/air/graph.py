...
main = expanduser('~/local/convergence/arf_fiber/wavelength/scalar/air')
...
fig, (ax1) = plt.subplots(1, 1, sharex=False, figsize=(30, 12))
...
# Set titles
fig.suptitle("Poletti Scalar Wavelength Study: C1 model",
             fontsize=30)

# Set axis labels
ax1.set_xlabel("\nWavelength", fontsize=26)
ax1.set_ylabel("CL", fontsize=26)
