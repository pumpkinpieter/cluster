...
path = os.path.relpath(main + 'wavelength/poly/outputs')
...
np.save(os.path.relpath(main + 'wavelength/data/poly_CL'), CL)
np.save(os.path.relpath(main + 'wavelength/data/poly_wls'), wls)
